...
var MyApp = {
    model: {
        count: _mithril2['default'].prop(0),
        inc: function inc() {
            _helpers2['default'].L('model inc called');
    ...
    controller: function controller() {
        ...
        this.inc = function () {
            _helpers2['default'].L('ctrl inc called');
            MyApp.model.inc();
        };
        return this;
    },
    view: function view(ctrl) {
        return (0, _mithril2['default'])('div', [(0, _mithril2['default'])('button', {
            onclick: ctrl.inc
        }, ctrl.count()), _mithril2['default'].component(_counter2['default'], { count: ctrl.count }), _mithril2['default'].component(_counter2['default'], { count: ctrl.count })]);
    }
};
_mithril2['default'].mount(document.body, MyApp);

},{"./counter":3,"./helpers":4,"mithril":2}],2:[function(require,module,exports){
...
exports['default'] = Counter = {
    ...
    view: function view(ctrl, args) {
        ...
        }, ctrl.count()), (0, _mithril2['default'])('br'), 'internal:', ctrl.count(), (0, _mithril2['default'])('br'), 'external:', args.count()]);
    }
};
module.exports = exports['default'];

},{"./helpers":4,"mithril":2}],4:[function(require,module,exports){
"use strict";
