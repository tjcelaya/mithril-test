...
MyApp = {
  controller: function() {
    ...
    _ctrl = {};
    _ctrl.now = m.prop(0);
    _ctrl.update = setInterval(function() {
      var current;
      current = _ctrl.now();
      if (current < 1000) {
        _ctrl.now(current + 1);
